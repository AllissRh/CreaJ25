              ...
              <div class="row">
                ...
                <div class="col-sm-6 d-flex flex-column justify-content-center align-items-center text-black">
                  ...
                  <form action="{{route('login') }}" method="post" style="width: 23rem;">
                    @csrf <!-- token -->
                    <h3 class="fw-normal mb-3 pb-2 text-center" style="letter-spacing: 1px;">INICIAR SESIÓN</h3>
                    <br>
                    <!-- Logo e ícono -->
                    <img  src="{{ asset('assets/person-circle.svg') }}" alt="" style="width: 100px; heigth:100px; margin-left:130px;">
<br><br>
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="password" id="form2Example28" minlength="6" class="form-control form-control-lg" name="password" />
                    </div>
                    ...
                    <p class="text-center">
                      ¿No tienes cuenta? <a href="{{ route('register') }}" class="link-info">Regístrate aquí</a>
                    </p>
                  </form>
                </div>
                ...
                <div class="col-sm-6 px-0 d-none d-sm-block position-relative">
                  ...
                  <!-- Imagen de fondo -->
                  <img src="{{asset("assets/perrini.avif")}}"
