...
<nav class="navbar navbar-dark fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                ...
                <li><a class="dropdown-item active" href="{{ route('docCita', $mascota->id) }}">Citas</a></li>
    ...
    <div class="d-flex justify-content-center " >
        ...
        <div class="btn-group" role="tablist">
            ...
            <a href="{{ route('docCita', $mascota->id) }}" class="btn btn-outline-primary active" role="tab">
            Crear Cita
            </a>

            <a href="{{ route('citas.mascota', $mascota->id) }}" class="btn btn-outline-primary" role="tab">
            Ver Citas
            </a>
...
@section('content')
    ...
    @if($mascotas->isEmpty())
        <p>No tienes mascotas con citas registradas.</p>
    @else
        @foreach($mascotas as $mascota)
            <div>
                <p>{{ $mascota->nombre }}</p>
                <a href="{{ route('citas.mascota', $mascota->id) }}" class="btn btn-outline-primary">
                    Ver Citas
                </a>
                <a href="{{ route('citas.crear', $mascota->id) }}" class="btn btn-success">
                    Crear Cita
                </a>
            </div>
        @endforeach
