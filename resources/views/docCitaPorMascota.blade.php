    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                ...
                <li><a class="dropdown-item" href="{{ route('vcitas.create', $mascota->id) }}">Crear Cita</a></li>
...
<div class="d-flex justify-content-center " >
        ...
        <div class="btn-group" role="tablist">
            ...
            <a href="{{ route('vcitas.create', $mascota->id) }}" class="btn btn-outline-dark " role="tab">
            Crear Cita
            </a>

            <a href="{{ route('vcitas.porMascota', ['usuarioId' => auth()->user()->id, 'mascotaId' => $mascota->id]) }}" class="btn btn-outline-dark active">
                ...
                <div class="card border-0 shadow-lg">
                    <div class="card-header bg-primary text-white py-3">
                        <h4 class="mb-0 fw-bold">
                            <i class="bi bi-heart-fill me-2 text-danger"></i>Citas de {{ $mascota->nombre }}
                        </h4>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bg-light border rounded-3 p-3 mb-4">
                            <form method="GET" action="{{ route('vcitas.porMascota', [$usuario->id, $mascota->id]) }}">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-4">
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('vcitas.porMascota', [$usuario->id, $mascota->id]) }}" 
                            ...
                            <table class="table table-hover align-middle">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th scope="col" class="fw-bold text-center">
                                            <i class="bi bi-gear me-2"></i>Acción
                                        </th>
                                    </tr>
                                </thead>
                                <tbody class="table-group-divider">
                                    @forelse($citas as $cita)
                                        <tr class="border-bottom">
                                            <td class="fw-semibold text-primary">{{ $cita->id }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('vcitas.destroy', $cita->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-outline-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar esta cita?')">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <form action="{{ route('vcitas.update', $cita->id) }}" method="POST">
                                                    ...
                                                    <h5 class="modal-title" id="editCitaModalLabel{{ $cita->id }}">Editar Cita</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select" name="hora" id="horaSelect" required>
