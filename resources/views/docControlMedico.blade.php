...
<head>
  ...
  <title>Control Medico-VitalVet</title>
...
<div class="d-flex justify-content-center my-4" style="margin-left: 35px;">
  <div class="btn-group" role="tablist">
    <a href="{{ route('consultas.create', $mascota->id) }}" class="btn btn-outline-primary active" role="tab">
      Crear Consulta
    </a>
    <a href="{{ route('consultas.docControlMedicoPet', ['id_mascota' => $mascota->id]) }}" class="btn btn-outline-primary " role="tab">
      Ver Consultas
    </a>
...
<div class="receta-container" >
    ...
    <div class="info-veterinario">
      ...
      <span>Medicina general veterinaria</span><br />
      <span>JVPMV#567</span>
    </div>
    ...
    @endif
        ...
        <form action="{{ route('consultas.store') }}" method="POST">
            ...
            <div class="mb-3">
                <label>Mascota: {{ $mascota->nombre }}</label>
            ...
            <div class="mb-3">
                <label>Anamnesico</label>
                <textarea name="anamnesico" placeholder="'Historial Medico Previo del Paciente'" class="form-control" required></textarea>
            </div>

            <div class="mb-3">
    <label>Estado Reproductivo</label>
    <p class="form-control">{{ $mascota->est_reproductivo ?? 'N/A' }}</p>
    <input type="hidden" name="estado_reproductivo" value="{{ $mascota->est_reproductivo }}">
</div>


            <div class="mb-3">
                <label>Alimentación</label>
                <select name="alimentacion" class="form-select" required>
                    <option value="">--Seleccione--</option>
                    <option value="Casera">Casera</option>
                    <option value="Balaceada">Balaceada</option>
            ...
            <a href="{{ route('consultas.docControlMedicoPet', ['id_mascota' => $mascota->id]) }}" class="btn btn-secondary">Volver al Listado</a>
       
            <!-- EN VOLVER AL LISTADO MOSTRAR EN GENERAL, LUEGO HACER UNA SIMILAR PARA MOSTRAR SOLO
                 LA DEL PACIENTE NO TODAS Y EN VER CONSULTA HACER QUE EL DOCTOR ELIMINE LA CONSULTA 
                 O QUE LA EDITE UNA DE LAS DOS, VER SI AGREGAR EL CAMPO ALERGIAS, ESTAS SON INSTRUCCIONES 
                 PARA MAS TARDE: ULTIMO CAMBIO 1:42 10-08-2025
            -->
        </form>
    </div>
